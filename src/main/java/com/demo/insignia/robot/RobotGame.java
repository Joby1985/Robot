...
import com.demo.insignia.robot.command.Command;
import com.demo.insignia.robot.command.CommandFactory;
...
public class RobotGame {
     ...
     * @return
     */
    private static Table createTable(final Properties properties) {
     ...
     */
    public static void play(Table table, List<String> commands) throws RobotException {
